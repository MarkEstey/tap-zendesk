...
class CustomObjectsStream(ZendeskOffsetStream):
    ...
    schema = PropertiesList(
        ...
        Property('created_at', DateTimeType, description="The time the object type was created"),
